...
Consider
\[
  z^T X^T diag[ \sigma(Xw) (1 - \sigma(Xw)) ] X z
\]
...
$ X^T diag[ \sigma(Xw) (1 - \sigma(Xw)) ] X $. For the gradient of the loss function with respect to $ w $, 
...
\]
\[
  w_{new} = w_{old} - \{X^T diag[ \sigma(Xw) (1 - \sigma(Xw)) ] X \}^{-1} [ X^T \sigma(Xw) - X^T y ]
\]
\end{document}
